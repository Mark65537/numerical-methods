...
//реализация функций класса Сплайн
...
void cubic_spline::build_spline(vector<long double>& x, vector<long double>& y, size_t n)
{
	free_mem();
	...
	splines = new spline_tuple[n];//на каждом отрезке свой многочлен
